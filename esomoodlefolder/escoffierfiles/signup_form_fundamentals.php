...
class login_signup_form_fundamentals extends moodleform {
    function definition() {
        global $USER, $CFG;
		...
		//tk added
		$scripts = '<div id="esco_js">
						<script src="http://my.escoffieronline.com/escoffierfiles/signup_fundamentals.js" type="text/javascript"></script>
						<script type="text/javascript">
							escoFillAccountInfo();
						</script>
					</div>';
		$mform->addElement('html', $scripts);
