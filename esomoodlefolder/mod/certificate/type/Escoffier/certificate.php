...
certificate_print_text($pdf, $x, $y + 47, 'C', 'Times', '', 16, 'On recommendation of the Chef Mentors');
certificate_print_text($pdf, $x, $y + 71, 'C', 'Times', '', 16, 'Does hereby confer on');
certificate_print_text($pdf, $x, $y + 112, 'C', 'Times', '', 28, fullname($USER));
certificate_print_text($pdf, $x, $y + 175, 'C', 'Times', 'I', 20, 'The Certificate of Completion for '.$course->fullname);
certificate_print_text($pdf, $x, $y + 250, 'C', 'Times', '', 16, 'Given on '.certificate_get_date($certificate, $certrecord, $course));
