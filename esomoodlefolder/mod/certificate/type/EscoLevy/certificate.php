...
certificate_print_text($pdf, $x, $y + 0, 'C', 'Times', 'I', 40, 'Certificate of Completion');
certificate_print_text($pdf, $x, $y + 70, 'C', 'Helvetica', 'B,I', 44, $course->fullname);
certificate_print_text($pdf, $x, $y + 135, 'C', 'Times', 'I', 14, 'Awarded to');
certificate_print_text($pdf, $x, $y + 170, 'C', 'Helvetica', '', 36, fullname($USER));
certificate_print_text($pdf, $x, $y + 250, 'C', 'Times', 'I', 14, 'On '.certificate_get_date($certificate, $certrecord, $course).' for the successful completion of the');
certificate_print_text($pdf, $x, $y + 265, 'C', 'Times', 'I', 14, 'Escoffier Online International Culinary Academy');
certificate_print_text($pdf, $x, $y + 280, 'C', 'Times', 'I', 14, $course->fullname.' Course');
if ($certificate->printhours) {
    certificate_print_text($pdf, $x, $y + 380, 'C', 'Helvetica', '', 16, $certificate->printhours . ' Continuing Education Hours');
}
