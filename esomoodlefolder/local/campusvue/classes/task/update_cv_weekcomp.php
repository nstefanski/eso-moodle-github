...
class update_cv_weekcomp extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('update_cv_weekcomp', 'local_campusvue');
    }
	...
	public function execute() {
		...
		$ua = updateAttendance($maxTime, $minTime, $token, 'weekcomp');
		if ($ua) {
			if ($ua->Attendances) {
