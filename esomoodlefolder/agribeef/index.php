...
require('../config.php');
global $CFG, $PAGE, $SESSION, $OUTPUT;//tk 3.1
...
if (isloggedin() and !isguestuser()) {
    ...
    redirect(new moodle_url('/course/view.php', array('id' => '1048'))); //tk redirect, but keep below outputs in case of failure
    echo $OUTPUT->header();
...
require_once($CFG->dirroot . '/agribeef/signup_form_agribeef.php');//tk 3.1

$mform_signup = new login_signup_form_agribeef(null, null, 'post', '', array('autocomplete'=>'on'));
