...
class login_signup_form_agribeef extends moodleform {
    function definition() {
        global $USER, $CFG;
		...
		//$mform->addElement('hidden', 'profile_field_Reseller', 'AgriBeef');
		...
		$mform->addElement('select', 'profile_field_Reseller', 'Organization', array('AgriBeef' => 'Agri Beef'));
		$mform->setDefault('profile_field_Reseller', 'AgriBeef');
